...
app.get('/api/restaurants/:blah', async (req, res) => {
    try {
...
app.post('/api/restaurants/:restaurant_id/menu', async (req, res) => {
    try {
...
app.post('/api/menus/:menu_id/menu_items', async (req, res) => {
    try {
...
app.get('/api/menus/:menu_id/menu_items', async (req, res) => {
    try {
        let menuItems;
        if (req.query.sort_by) {
...
app.get('/api/menus/:menu_id/menu_items/:menu_item_id', async (req, res) => {
    try {
...
app.put('/api/menus/:menu_id/menu_items/:menu_item_id', async (req, res) => {
    try {
        const menuItemId = req.params.menu_item_id;
...
app.delete('/api/menus/:menu_id/menu_items/:menu_item_id', async (req, res) => {
    try {
        const menuItemId = req.params.menu_item_id;
